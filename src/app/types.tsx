...
export const GAMES = [
    ...
    { title: "Dawn of Violence (Kurohyou)", intro: "J1v4qUTi1Xo", main: "J1v4qUTi1Xo"}
]
...
export const getPageStyle = (page: string, isChatPanel?: boolean): string => {
    ...
    switch (page) {
        ...
        case "Casino":
            return `border-2 border-white/30 backdrop-blur-sm text-white/50 rounded-[10] ${!isChatPanel && "hover:opacity-100"}`
        case "Moneylender":
