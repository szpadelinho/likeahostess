                    ...
                    <div className={"flex content-center justify-center items-center flex-row text-[25px] gap-10"}>
                        <button onClick={() => {
                            router.push("/selection");
                                ...
                                className={"border-white bg-pink-600 border-2 rounded-[12] p-1 cursor-zoom-in w-50 hover:bg-white hover:text-black transition-all duration-200 ease-in-out transform active:scale-110"}>Get
                            in the cab
                        </button>
                        <button onClick={onCloseModal}
                                className={"border-white bg-pink-600 border-2 rounded-[12] p-1 cursor-zoom-out w-50 hover:bg-white hover:text-black transition-all duration-200 ease-in-out transform active:scale-110"}>I
                            will stay
                        </button>
                    </div>
                </div>
